...
export default function LoginPage() {
	const googleLogin = () => {
		window.open('https://o-auth-backend-tue.herokuapp.com/auth/google', '_self');
	};

	const githubLogin = () => {
		window.open('https://o-auth-backend-tue.herokuapp.com/auth/github', '_self');
	};

	const twitterLogin = () => {
		window.location.href = 'https://o-auth-backend-tue.herokuapp.com/auth/twitter';
	};
